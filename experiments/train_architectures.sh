...
python train.py --root data/cleaned/ --image-root /mnt/DADES/datasetcalibracio/ \
--ckpt-name bronchonet_15traj_l10_COS_arch   --batch-size 1 --model doublelatetemporal  --gpus=1 \
...
python train.py --root data/cleaned/ --image-root /mnt/DADES/datasetcalibracio/ \
--ckpt-name bronchonet_15traj_l10_COS_arch  --batch-size 1 --model doublelate  --gpus=1 \
--predict --pred-folder ./data/cleaned/preds_15traj_COS_arch 