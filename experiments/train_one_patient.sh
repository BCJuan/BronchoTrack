...
--gpus 1,2 --accelerator 'ddp' --lr 0.0001 --rot-loss cos --length 2 --pos-loss mse
...
--gpus 1,2 --accelerator 'ddp' --lr 0.0001 --rot-loss direction --length 2 --pos-loss mse
...
--gpus 1,2 --accelerator 'ddp' --lr 0.0001 --rot-loss quaternion --length 2 --pos-loss mse
